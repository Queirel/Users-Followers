...
export class Init1688805624872 implements MigrationInterface {
    name = 'Init1688805624872'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "task" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "task_name" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'ONTIME', "progress" character varying NOT NULL DEFAULT 'CREATED', "must_start_date" TIMESTAMP NOT NULL, "start_date" TIMESTAMP, "must_completion_date" TIMESTAMP NOT NULL, "completion_date" TIMESTAMP, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`);
